...
_lr_productions = [
  ...
  ('stat -> VAR = exp','stat',3,'p_stat_VAR','enunciado.py',38),
  ('stat -> exp','stat',1,'p_stat_exp','enunciado.py',42),
  ('exp -> exp + exp','exp',3,'p_exp_plus','enunciado.py',48),
  ('exp -> exp - exp','exp',3,'p_exp_sub','enunciado.py',53),
  ('exp -> exp * exp','exp',3,'p_exp_mult','enunciado.py',58),
  ('exp -> exp / exp','exp',3,'p_exp_div','enunciado.py',62),
  ('exp -> - exp','exp',2,'p_exp_UMINUS','enunciado.py',66),
  ('exp -> ( exp )','exp',3,'p_exp_parentesis','enunciado.py',70),
  ('exp -> NUMBER','exp',1,'p_exp_NUMBER','enunciado.py',74),
  ('exp -> VAR','exp',1,'p_exp_VAR','enunciado.py',78),
]
